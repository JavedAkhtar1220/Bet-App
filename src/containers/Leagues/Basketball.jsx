...
const Basketball = () => {
    ...
    const goToLeague1 = () => {
        history.push('/basketballleague1');
    }

    const goToLeague2 = () => {
        history.push('/basketballleague2');
    }

    const goToLeague3 = () => {
        history.push('/basketballleague3');
    }
                ...
                <div className="col-lg-6 col-md-8 col-12 mx-auto bg-white rounded shadow">
                    <div className="row">
                        <div className="col-lg-10 col-md-10 col-sm-10 col-10 mx-auto">
                            <h1 className="signup_title text-center mt-4">Select Basketball League</h1>
