...
const Cyclism = () => {
    ...
    useEffect(() => {
        document.title = "Sport Bet || Cyclism";
        ...
        <div>
            ...
            <div className="row">
                <div className="col-8 m-auto">
                    ...
                    <FavTeam />
                    <h1 className="signup_title text-center mt-4">Cyclisme</h1>
                                    ...
                                    <div className="col-10">
                                        <div className="row">
                                            <div className="col-lg-4 col-md-4 col-sm-4 col-12 d-flex justify-content-center align-items-center">
                                                <img src={cyclisme} alt="Non Professional League" className="leagueImg" />
                                            </div>
